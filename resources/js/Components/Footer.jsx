            ...
            <div className="container mx-auto max-w-6xl">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a href={route("home")} className="text-gray-600 hover:text-sky-600">Home</a>
                            </li>
                            <li>
                                <a href={route("documentation.api")} className="text-gray-600 hover:text-sky-600">API Documentation</a>
                            </li>
                            <li>
                                <a href={route("register")} className="text-gray-600 hover:text-sky-600">Register</a>
                            </li>
                            <li>
                                <a href={route("login")} className="text-gray-600 hover:text-sky-600">Login</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
                    ...
                    <p className="text-gray-600 text-sm flex items-center">
                        ...
                        <a className="text-sky-600 hover:text-sky-700 font-medium ml-1" href="https://msamgan.com">
                            msamgan
                        </a>
                    </p>
                </div>
