                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <div>
                        ...
                        <p className="text-gray-600 mb-4">
                            A modern URL shortener service that helps you create, manage, and track shortened
                            links with ease.
                        </p>
                        <div className="flex space-x-4">
                            <a
                                href="https://github.com/msamgan/ms0"
                                className="text-gray-600 hover:text-sky-600 flex items-center bg-gray-100 hover:bg-gray-200 p-2 rounded-lg"
                                aria-label="GitHub"
                            >
                                <svg
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a href={route("home")} className="text-gray-600 hover:text-sky-600">
                                    Home
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href={route("register")} className="text-gray-600 hover:text-sky-600">
                                    Register
                                </a>
                            </li>
                            <li>
                                <a href={route("login")} className="text-gray-600 hover:text-sky-600">
                                    Login
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mb-4">
                            MS0 is an open-source URL shortener built with Laravel and React. It provides a
                            simple and efficient way to shorten long URLs.
                        </p>
                        <a
                            href="https://github.com/msamgan/ms0"
                            className="inline-flex items-center px-4 py-2 bg-sky-100 text-sky-700 rounded-lg hover:bg-sky-200"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
