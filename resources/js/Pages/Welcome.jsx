        ...
        <>
            ...
            <section className="bg-white text-gray-800 py-20">
                <div className="container mx-auto px-4 md:px-10 lg:px-12 max-w-full lg:max-w-[100rem]">
                    ...
                    <div className="mt-8 w-full lg:max-w-[100rem] mx-auto">
                        {error && (
                    ...
                    {/* Features Section */}
                    <div className="py-16 w-full lg:max-w-[100rem] mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                            <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-lg">
                                ...
                                <h3 className="text-gray-800 mb-2">Lightning Fast</h3>
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-lg">
                                ...
                                <h3 className="text-gray-800 mb-2">Secure & Reliable</h3>
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-lg">
                                ...
                                <h3 className="text-gray-800 mb-2">Detailed Analytics</h3>
                    ...
                    {isAuthenticated ? (
                        <div className="w-full lg:max-w-[100rem] mx-auto mb-16">
                            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                                ...
                                <div className="mt-8 flex justify-center">
                                    <a href={route("dashboard")} className="px-8 py-4 text-base font-semibold rounded-xl bg-sky-600 text-white shadow-md hover:shadow-lg inline-flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="w-full lg:max-w-[100rem] mx-auto mb-16">
                            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                                ...
                                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                                    <a href={route("register")} className="w-full sm:w-auto px-8 py-4 text-base font-semibold rounded-xl bg-sky-600 text-white shadow-md hover:shadow-lg inline-flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                        </svg>
                                        Register Now
                                    </a>
                                    <a href={route("login")} className="w-full sm:w-auto px-8 py-4 text-base font-semibold rounded-xl bg-white border border-sky-200 text-sky-600 hover:bg-sky-50 shadow-sm hover:shadow inline-flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
