...
export default function Welcome({}) {
    ...
    return (<>
        ...
        <section className="bg-gray-100 text-gray-800">
            <div
                className="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-4xl">
                <h1 className="text-3xl font-bold leading-none sm:text-3xl">You know what to do, right?
                    <span className="text-sky-600"> Shorten It</span>
                </h1>
                <fieldset className="w-full space-y-1 text-gray-800 mt-6">
                    <div className="flex">
                        <input type="text" name="url" id="url" placeholder="paste your url here"
        ...
        <footer className="px-4 divide-y bg-gray-100 text-gray-800 mt-96">
            <div className="py-6 text-sm text-center text-gray-600">© {new Date().getFullYear()}. All rights reserved.
                Made with ❤️ by <a className={'text-sky-600'} href={'https://msamgan.com'}> msamgan</a>
            </div>
        </footer>
    </>);
}
